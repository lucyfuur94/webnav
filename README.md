...
graph/     seed.ts, route.ts, hop.ts, export.ts, teach.ts, html.ts        the internet graph + viewer
...
All current work is merged to `main`, 192 tests green. See **`docs/STATUS.md`** for the live
checklist, pending work (next: verify the HTML viewer render, then the A/B benchmark), and known
